...
public:
  ...
  void setup2016ULPreVFP(std::shared_ptr<uhh2::AnalysisModule> module);
  void setup2016ULPostVFP(std::shared_ptr<uhh2::AnalysisModule> module);
  void setup2016UL(std::shared_ptr<uhh2::AnalysisModule> module);
...
private:
  ...
  std::shared_ptr<uhh2::AnalysisModule> module2016_, module2016v2_, module2016v3_, module2016ULPreVFP_, module2016ULPostVFP_, module2016UL_;
