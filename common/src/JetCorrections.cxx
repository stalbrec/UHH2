...
JetResolutionSmearer::JetResolutionSmearer(uhh2::Context & ctx){
  ...
  m_gjrs = new GenericJetResolutionSmearer(ctx, "jets", "genjets", JERFiles::JERPathString(jer_tag,jetCollection,"SF"), JERFiles::JERPathString(jer_tag,jetCollection,"PtResolution"));
